...
RUNNING = [
    ...
    pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoRun4.png")),
]
...
RUNNING_SHIELD = [
    ...
    pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoRun4Shield.png")),
]
...
DUCKING_SHIELD = [
    ...
    pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoDuck3Shield.png")),
    pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoDuck4Shield.png")),
]
...
GAME_OVER_MESSAGE = pygame.image.load(os.path.join(IMG_DIR, 'Other/GameOver.png'))
